        ...
        <table className="w-full text-xs">
          <thead className="bg-[#2d2d30]">
            <tr>
              ...
              <th className="text-left px-2 py-1.5 font-medium text-[#999]">Question</th>
              <th className="text-center px-2 py-1.5 font-medium text-[#999]">Result</th>
              <th className="text-right px-2 py-1.5 font-medium text-[#999]">Latency</th>
              <th className="text-right px-2 py-1.5 font-medium text-[#999]">Tokens</th>
              <th className="text-right px-2 py-1.5 font-medium text-[#999]">Tools</th>
            </tr>
          </thead>
